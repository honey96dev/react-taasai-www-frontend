          ...
          <div id="roundup_section" className="container">
            <div className="row align-items-center">
              <div className="col-md-7 order-1 order-md-0">
                <h1 className="roundup-heading">We built Taasai with community values in mind and to help harness the giving spirit of every community. When you ride local with Taasai, you can elect to round up your fare to the nearest Pound - and designate a local charity</h1>
